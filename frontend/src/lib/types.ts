...
export type Reading = { stationId: string; timestamp: string; pm25: number; pm10: number; no2: number; o3: number; co: number; temp?: number; rh?: number; ws?: number; wd?: number; rf?: number; so2?: number; nh3?: number; aqi: number };
export type PredictionInput = { pm25: number; pm10: number; no2?: number; o3?: number; co?: number; temp?: number; rh?: number; ws?: number; wd?: number; rf?: number; so2?: number; nh3?: number; model_id?: string };
